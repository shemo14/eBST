                    ...
                    <View style={{padding: 20, top: -80}}>
                        ...
                        <View style={{}}>
                            ...
                            <Form>
                                <Textarea rowSpan={3} style={{
                                    ...
                                    fontFamily: 'cairo',
                                    textAlign: 'right'
                                }} bordered placeholder={i18n.t('addComment')}
                                          placeholderTextColor={{color: "#acabae"}}/>
                                <View style={{
                                    alignItems: 'center',
                        ...
                        <View style={{marginTop: 30}}>
                            <Button onPress={() => this.props.navigation.navigate('confirmOrder')} style={{
                                ...
                                <View
                                    style={{backgroundColor: '#fff', height: 1, width: 30, top: -14, left: -14}}></View>
                                <Text
                                    style={{color: '#fff', fontSize: 15, fontFamily: 'cairo',}}>{i18n.t('order')}</Text>
                                <View
                                    style={{backgroundColor: '#fff', height: 1, width: 30, top: 14, right: -14}}></View>
                            </Button>
                        </View>
                            ...
                            <View style={{
                                ...
                                <Form>
                                    <Textarea style={{
                                        ...
                                        fontFamily: 'cairo',
                                        textAlign: 'right'
                                    }} rowSpan={7} bordered placeholder={i18n.t('reportReason')}
                                              placeholderTextColor={{color: "#acabae"}}/>
                                ...
                                <TouchableOpacity onPress={this._toggleModal}
                                    ...
                                    <Image source={require('../../assets/images/refused.png')}
